...
function handleWindowResize() {
    ...
    fullpage.style.width = $('.facesView').innerWidth + "px";
    fullpage.style.height = $('.facesView').innerHeight + "px";
    ...
    applyReshape(fullpage, $('.facesView').innerWidth, $('.facesView').innerHeight);
}
